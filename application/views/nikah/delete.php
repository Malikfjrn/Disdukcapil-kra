  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="<?php echo base_url('nikah/') ?>">Nikah</a></li>
    ...
    <section class="content">
      ...
      <div class="row">
        <div class="col-md-12 col-xs-12">
          ...
          <form action="<?php echo base_url('nikah/delete/'.$id) ?>" method="post">
            <input type="submit" class="btn btn-primary" name="confirm" value="Konfirmasi">
            <a href="<?php echo base_url('nikah') ?>" class="btn btn-warning">Batal</a>
          </form>
