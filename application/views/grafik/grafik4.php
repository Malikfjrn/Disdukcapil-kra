...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Grafik Percerain Islam</li>
        </ol>
    </section>
            ...
            <div class="col-md-12 col-xs-12">
                ...
                <div style="max-width:90%; max-height:70%;padding-right:5%;padding-left:15%">
                    ...
                    <div id="chart-info">
                        ...
                        <div>
                        <h3>Total Perceraian Islam = <?php echo $total_perceraianislam ?></h3>
...
<script>
    ...
    $(document).ready(function() {
      ...
      $("#view4GrafikSubNav").addClass('active');
    });
  </script>