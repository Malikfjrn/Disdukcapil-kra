...
class Perceraianislam extends Admin_Controller 
{
	...
	public function create()
	{
		...
		$this->form_validation->set_rules('kecamatan_pria', 'Kecamatan Pria', 'trim|required', array(
			'required' => 'Kolom Kecematan Pria harus diisi.',));
		...
		$this->form_validation->set_rules('kabupaten_wanita', 'Kabupaten Wanita', 'trim|required', array(
			'required' => 'Kolom Kabipaten Wanita harus diisi.',));
		...
		$this->form_validation->set_rules('no_perceraianislam', 'No Perceraianislam', 'trim|required', array(
			'required' => 'Kolom No Perceraian Islam harus diisi.',));
        $this->form_validation->set_rules('tanggal_perceraianislam', 'Tanggal Perceraianislam','trim|required', array(
			'required' => 'Kolom Tanggal Perceraian Islam harus diisi.',));
